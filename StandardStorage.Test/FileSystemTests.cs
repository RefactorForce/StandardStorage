...
namespace StandardStorage.Test
{
    ...
    public class FileSystemTests
    {
        ...
        public async Task GetFileFromPath()
        {
            ...
            string expectedPath = Path.Combine(folder.Path, fileName);
        ...
        public async Task GetFileFromPath_WhenFileDoesNotExist()
        {
            ...
            string pathForFile = Path.Combine(folder.Path, "filethatdoesnotexist.txt");
        ...
        public async Task GetFileFromPath_WhenFolderDoesNotExist()
        {
            ...
            string pathForFile = Path.Combine(rootFolder.Path, "NotAFolder", "file.txt");
        ...
        public async Task GetFolderFromPath_WhenFolderDoesNotExist()
        {
            //  Arrange
            IFolder rootFolder = TestFileSystem.LocalStorage;
            string pathForFolder = Path.Combine(rootFolder.Path, "FolderThatDoesNotExist");
